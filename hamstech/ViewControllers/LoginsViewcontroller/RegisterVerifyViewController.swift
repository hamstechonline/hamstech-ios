...
class RegisterVerifyViewController: UIViewController, GMSMapViewDelegate, CLLocationManagerDelegate, UITextFieldDelegate , URLSessionDelegate, URLSessionDataDelegate {
    ...
    ActivityServiceCalling(Pagename: "RegisterVerify", Activity: "Viewed")
...
//            }}
    ...
    func reigiterverifyServiceCalling() {
             ...
             let otptimestamp: Int = UserDefaults.standard.object(forKey: "otptimestamp") as? Int ?? 0
               ...
               let fcmToken: String = UserDefaults.standard.object(forKey: "fcmToken") as? String ?? ""
                             ...
                             let Urlname =  "\(ConstantsKeys.AppLinks.BaseUrl)\(ConstantsKeys.AppGetUrls.verifylogin)"
                                ...
                                let params  = ["appname":ConstantsKeys.apikey.appname,"apikey":ConstantsKeys.apikey.api_key,"page":"registration","name":nameTextField.text!,"phone":mobileNumberTextField.text!,"cityName":city,"user_address":address,"user_state":state,"user_pincode":pincode,"user_country":pincode,"otp":otpTextField.text!,"otptimestamp":otptimestamp,"gcm_id":fcmToken,"countrycode":"91","lang":ConstantsKeys.apikey.lan,"device":"ios","networkconnection": self.networkMode, "downSpeed":self.networkspeed, "upSpeed":self.networkupspeed,"last_number": last_number] as [String : Any]
                ...
                if let status = response["status"] as? NSDictionary {
                    ...
                    print("status2", status2)
                     ...
                     // let profilepic:String =   String(data["profilepic"] as! String)
                      ...
                      UserDefaults.standard.set(self.mobileNumberTextField.text!, forKey: "phonenumber")
                      UserDefaults.standard.set(prospectname, forKey: "prospectname")
                     // UserDefaults.standard.set(profilepic, forKey: "profilepic")
                      
                      
                      let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "WelcomeViewController") as? WelcomeViewController
                      self.navigationController?.pushViewController(vc!, animated: true)
    ...
    func resendServiceCalling() {
                     ...
                     let Urlname =  "\(ConstantsKeys.AppLinks.BaseUrl)\(ConstantsKeys.AppGetUrls.getotp)"
                      ...
                      let params  = ["page":"registration","phone":mobileNumberTextField.text!,"countrycode":"91","lang":ConstantsKeys.apikey.lan] as [String : Any]
    ...
    @IBAction func resentotp_Action(_ sender: Any) {
        
        if mobileNumberTextField.text == "" {self.customPresentAlert(withTitle: "", message: "Please Enter Mobile Number")}
        else {resendServiceCalling()}
