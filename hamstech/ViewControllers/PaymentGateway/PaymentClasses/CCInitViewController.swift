...
//        textField.text = "http://122.182.6.216/merchant/ccavResponseHandler.jsp".trimmingCharacters(in: .whitespacesAndNewlines)
//        textField.layer.borderWidth = 1
//        textField.layer.borderColor = UIColor.lightGray.cgColor
//        textField.keyboardType = .emailAddress
//        textField.translatesAutoresizingMaskIntoConstraints = false
...
//        textField.text = "https://secure.ccavenue.com/transaction/jsp/GetRSA.jsp".trimmingCharacters(in: .whitespacesAndNewlines) //
//
//        textField.layer.borderWidth = 1
//        textField.layer.borderColor = UIColor.lightGray.cgColor
//        textField.keyboardType = .emailAddress
...
//        let attributedTitle = NSMutableAttributedString(string: "Submit", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium), NSAttributedString.Key.foregroundColor: Color.orange])
...
//        let button = DesignableButton()
//        let attributedTitle = NSMutableAttributedString(string: "Cancel", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 17, weight: UIFont.Weight.medium), NSAttributedString.Key.foregroundColor: Color.orange])
//        button.setAttributedTitle(attributedTitle, for: .normal)
//        button.setTitleColor(Color.orange, for: .normal)
//        button.cornerRadius = 5
//        button.borderWidth = 1
...
//                isError = true
//                self.amountTextField.layer.borderColor = UIColor.red.cgColor
//                let alert: UIAlertController = UIAlertController(title: "ERROR", message: "Amount should be greater than 0", preferredStyle: UIAlertController.Style.alert)
